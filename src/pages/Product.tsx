          ...
          <div className="max-w-6xl mx-auto">
                ...
                <div className="relative">
                  ...
                  <div className="w-80 h-80 bg-gradient-to-br from-orange-100 to-orange-200 rounded-2xl flex items-center justify-center shadow-lg">
                    <div className="text-center">
                      ...
                      />
                      <h3 className="text-xl font-semibold text-gray-700 mb-2">SocialBirds</h3>
            ...
            <div className="flex justify-center mt-8">
              <div className="flex items-center space-x-4">
                ...
                <span className="text-orange-600 font-semibold">Currently Available</span>
              </div>
            </div>
          </div>
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-6xl mx-auto">
            ...
            <div className="flex justify-center mt-8">
              <div className="flex items-center space-x-4">
                <div className="w-3 h-3 bg-orange-500 rounded-full animate-pulse"></div>
                <span className="text-orange-600 font-semibold">More products launching soon</span>
              </div>
            </div>
          </div>
        </div>
