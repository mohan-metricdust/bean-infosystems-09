      ...
      <PageSection>
        <div className="max-w-5xl mx-auto space-y-8">
          ...
          <div className="space-y-6 text-gray-800 text-lg leading-relaxed">
            <p>
              Bean Infosystems devote a portion of its time augmenting social impact with Nonprofits and Social Enterprises. We believe in the need for social impact activities at the core of our business and not just another CSR initiative.
            </p>
            <p>
